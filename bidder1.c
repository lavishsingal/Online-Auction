/*
 ** BIDDER1.c --
 In this file the bidder#1 is sending authentication data and various items and prices which he/she wants to sell.
 Flow:
...
//#define bidding1 "/Users/lavishsingal/desktop/socket_programming/inputfiles/bidding1.txt"
//#define filepath2 "/Users/lavishsingal/desktop/socket_programming/inputfiles/bidderPass1.txt"
/*#define bidding1 "/Users/lavishsingal/desktop/socket_programming/inputfiles/test/bidding1.txt"
#define filepath2 "/Users/lavishsingal/desktop/socket_programming/inputfiles/test/bidderPass1.txt"
*/


/// FOR NUNKI/////
#define bidding1 "bidding1.txt"
#define filepath2 "bidderPass1.txt"
...
//////////////// BIDDER PORT - PHASE3 /////////////////
#define BIDUPORT1 "3253"  // tcp ports where bidder is listening for final data
#define BIDTPORT2 "4253"
...
int connServer_phase1(int argc , const char * argv[] ,char* login){
    ...
    printf("\nPhase 1: <Bidder#> 1 has TCP port %hu and IP address: %s\n",sa.sin_port,ipstr);
...
int listenserver()
{
    ...
    //lavish confused with ip
    printf("\nPhase 3: <Bidder#> 1 has UDP port %s and IP address: %s \n",BIDUPORT1,ipstr);
    ...
    if((numbytes = sendto(sockfd,biditems,strlen(biditems),0,(struct sockaddr *)&their_addr,addr_len)) == -1){
        ...
        printf("\nPhase 3: <Bidder#1> (Bidding information displayed here)\n%s\n",displaybiditems);
    }
...
int finishphase3(){
    ...
    if ((rv = getaddrinfo(IPSTR, BIDTPORT2, &hints, &servinfo)) != 0) {
        fprintf(stderr, "getaddrinfo: %s\n", gai_strerror(rv));
        return 1;
    }
