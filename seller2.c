/*
 ** SELLER2.c --
 In this file the seller#2 is sending authentication data and various items and prices which he/she wants to sell.
 Flow:
...
/*#define filepath2 "/Users/lavishsingal/desktop/socket_programming/inputfiles/test/sellerPass2.txt"
#define itemlist1 "/Users/lavishsingal/desktop/socket_programming/inputfiles/test/itemList2.txt"
*/

/// FOR NUNKI/////
#define filepath2 "sellerPass2.txt"
...
void displayresult(){
    ...
    printf("\nEnd of Phase 3 for <Seller#2>.\n");
    
    
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////  ACCEPTED  FOR SELLER (parse the packet sent from the server whether it is accepted or rejected)////////
...
int connServer_phase1(int argc , const char * argv[] ,char* login){
    ...
    //lavish
    printf("\nPhase 1: <Seller#2> has TCP port %hu and IP address: %s\n",sa.sin_port,ipstr);
...
///////////////////////////////////////////////////////////////////////////////////////////////
///////////////  Connect To Server PHASE2- send the items to the server which is listening /////////////////
//////////////////////////////////////////////////////////////////////////////////////////////
...
int connServer_phase2(){
    ...
    printf("\nPhase 2: <Seller#2> send item lists.\nPhase 2:(Item list displayed here)\n%s\n",items);
    ...
    close(sockfd);
    printf("\nEnd of Phase 2 for <Seller#2>.\n");
	
	// start listening for the final items
	finishphase3();
...
int finishphase3(){
    ...
    if ((rv = getaddrinfo(IPSTR, SELLPORT2, &hints, &servinfo)) != 0) {
        fprintf(stderr, "getaddrinfo: %s\n", gai_strerror(rv));
        return 1;
    }
